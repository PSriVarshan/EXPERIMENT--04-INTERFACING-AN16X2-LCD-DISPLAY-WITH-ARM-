...
MX_GPIO_Init();
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
    ...
    Lcd_cursor(&lcd, 0,1);
    Lcd_string(&lcd, "Sri Varshan P");
    Lcd_cursor(&lcd, 1,1);
    Lcd_string(&lcd, "212222240104");
while (1)
  {
}
}
...
![image](https://github.com/user-attachments/assets/e1d86e06-3dfa-4509-8b46-0d01dc07ae8d)


 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
![image](https://github.com/user-attachments/assets/9871e6c1-f3e7-4619-bff9-a2b95a7e8b6e)
